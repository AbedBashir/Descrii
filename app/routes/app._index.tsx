      ...
      <svg width="130" height="130" viewBox="0 0 130 130">
        ...
        {!isUnlimited && (
          <circle
            ...
            fill="none"
            stroke={
              progress > 0.8 ? "#d72c0d" : progress > 0.6 ? "#f49342" : color
            }
            strokeWidth="12"
            strokeLinecap="round"
...
export default function Home() {
  const { plan, planName, limits, productsUsed, collectionsUsed, activity } =
    useLoaderData<typeof loader>();
  const isNewUser =
    productsUsed === 0 && collectionsUsed === 0 && activity.length === 0;

  return (
    <s-page heading="Descrii">
      {isNewUser && (
          ...
          >
            <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
              ...
              <div>
                ...
                >
                  <a href="/app/settings" style={{ color: "#008060" }}>
                    Go to Settings →
                  </a>
                </p>
              </div>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
              ...
              <div>
                ...
                >
                  <a href="/app/products" style={{ color: "#008060" }}>
                    Go to Products →
                  </a>
                </p>
              </div>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
              ...
              <div>
                ...
                >
                  Try bulk generation to save time
                </p>
                <p
                  style={{
                    margin: 0,
                ...
                >
                  Select multiple products at once from either page
                </p>
              </div>
            </div>
          </div>
      ...
      <s-section heading="Usage this month">
        <div style={{ display: "flex", gap: "16px", flexWrap: "wrap" }}>
          <UsageCircle
            used={productsUsed}
            total={limits.products}
            label="Products"
          />
          <UsageCircle
            used={collectionsUsed}
            total={limits.collections}
            label="Collections"
            color="#5c6ac4"
          />
        </div>
      ...
      <s-section heading="Your plan" slot="aside">
        ...
        >
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "6px" }}>
            ...
            >
              📝 {productsUsed}/
              {limits.products === Infinity ? "∞" : limits.products} products
            </p>
            <p
              style={{
                margin: 0,
            ...
            >
              📦 {collectionsUsed}/
              {limits.collections === Infinity ? "∞" : limits.collections}{" "}
              collections
            </p>
          </div>
        </div>
      ...
      <s-section heading="Tips" slot="aside">
        <s-unordered-list>
          <s-list-item>
            Select a product from your store to auto-fill details.
          </s-list-item>
          <s-list-item>
            Bulk generate to save time on large catalogs.
          </s-list-item>
          <s-list-item>
